...
function Library:new()
    ...
    local mobile_button = Instance.new("TextButton")
        ...
        mobile_button.Position = UDim2.new(0.0210955422, 0, 0.345, 0)
        mobile_button.Size = UDim2.new(0, 38, 0, 38)
